...
def run():
    ...
    demo_files = glob.glob(f"{demo_path}/*-trex.pickle")

    demonstrations = [pickle.load(open(demo_name, 'rb'), encoding='latin1') for demo_name in demo_files]

    # get ranking of demonstrations
